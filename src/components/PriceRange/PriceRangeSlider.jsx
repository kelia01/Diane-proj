...
//                 <p className="price-text">{currencyText} {minVal}</p>
//                 <div className="price-divider"></div>
//                 <p className="price-text">{currencyText} {maxVal}</p>
//             </div>
...
//                     }}
//                     className="thumb thumb-left"
//                     style={{ width, zIndex: minVal > max - 100 || minVal === maxVal ? 5 : undefined }}
//                 />
...
//                     }}
//                     className="thumb thumb-right"
//                     style={{ width, zIndex: minVal > max - 100 || minVal === maxVal ? 4 : undefined }}
//                 />

//                 <div className="slider">
//                     <div style={{ border: `1px solid ${rangeColor}` }} className="track-slider" />
